...
@app.generic_trigger(
    arg_name="req", type="httpTrigger", route="eventgrid_output_binding"
)
...
@app.generic_trigger(
    arg_name="req", type="httpTrigger", route="eventgrid_output_binding_success"
)
@app.generic_output_binding(arg_name="$return", type="http")
...
@app.generic_trigger(
    arg_name="req", type="httpTrigger", route="get_eventgrid_triggered"
)
@app.generic_output_binding(arg_name="$return", type="http")
@app.generic_input_binding(
    arg_name="file",
