...
from azure_functions_worker_v1.handle_event import otel_manager, worker_init_request
from azure_functions_worker_v1.otel import (initialize_azure_monitor,
                                            update_opentelemetry_status)
from azure_functions_worker_v1.logging import logger
...
class TestOpenTelemetry(unittest.TestCase):
    ...
    @patch('builtins.__import__')
    @patch("azure_functions_worker_v1.otel.update_opentelemetry_status")
