...
async def parallelly_log_exception():
    ...
    try:
        ...
        logging.exception(
            "parallelly_log_exception at root logger", exc_info=sys.exc_info()
        )
...
def multiple_set_cookie_resp_headers(req: func.HttpRequest) -> func.HttpResponse:
...
def set_cookie_resp_header_default_values(req: func.HttpRequest) -> func.HttpResponse:
    logging.info("Python HTTP trigger function processed a request.")
    resp = func.HttpResponse("This HTTP triggered function executed successfully.")
...
def set_cookie_resp_header_empty(req: func.HttpRequest) -> func.HttpResponse:
    logging.info("Python HTTP trigger function processed a request.")
    resp = func.HttpResponse("This HTTP triggered function executed successfully.")
