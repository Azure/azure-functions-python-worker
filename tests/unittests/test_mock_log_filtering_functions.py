    ...
    async def test_sdk_logger_should_be_system_log(self):
        ...
        with patch(
            ...
            async with testutils.start_mockhost(script_root=self.dir) as host:
                ...
                self.assertIn(call("azure.functions"), islc_mock.call_args_list)
    ...
    async def test_sdk_submodule_logger_should_be_system_log(self):
        ...
        with patch(
            ...
            async with testutils.start_mockhost(script_root=self.dir) as host:
                ...
                self.assertTrue(is_system_log_category("azure.functions.submodule"))

    async def _invoke_function(self, host: testutils._MockWebHost, function_name: str):
