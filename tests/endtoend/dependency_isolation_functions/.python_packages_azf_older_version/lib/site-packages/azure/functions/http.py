...
class HttpRequest(azf_http.HttpRequest):
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(body, str):
            ...
            raise TypeError(f"unexpected HTTP request body type: {type(body).__name__}")
    ...
    def get_json(self) -> typing.Any:
        if self.__body_type in ("json", "string"):
            ...
            raise ValueError("Request body cannot be empty in JSON deserialization")
...
class HttpRequestConverter(meta.InConverter, binding="httpTrigger", trigger=True):
