...
@app.generic_trigger(arg_name="req", type="httpTrigger", route="eventhub_output")
...
@app.generic_trigger(arg_name="req", type="httpTrigger", route="get_eventhub_triggered")
@app.generic_output_binding(arg_name="$return", type="http")
...
def get_eventhub_triggered(req: func.HttpRequest, file: func.InputStream) -> str:
    return file.read().decode("utf-8")


# Retrieve the event data from storage blob and return it as Http response
@app.function_name(name="get_metadata_triggered")
@app.generic_trigger(arg_name="req", type="httpTrigger", route="get_metadata_triggered")
@app.generic_output_binding(arg_name="$return", type="http")
@app.generic_input_binding(
    arg_name="file",
    type="blob",
...
async def get_metadata_triggered(req: func.HttpRequest, file: func.InputStream) -> str:
...
@app.generic_trigger(arg_name="req", type="httpTrigger", route="metadata_output")
@app.generic_output_binding(arg_name="$return", type="http")
