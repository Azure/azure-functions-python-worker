...
@app.queue_output(
    arg_name="msg", connection="AzureWebJobsStorage", queue_name="testqueue"
)
...
@app.queue_output(
    arg_name="$return", connection="AzureWebJobsStorage", queue_name="testqueue-return"
)
...
@app.queue_trigger(
    arg_name="msg", queue_name="testqueue", connection="AzureWebJobsStorage"
)
@app.blob_output(
    arg_name="$return",
    connection="AzureWebJobsStorage",
...
@app.queue_trigger(
    arg_name="msg", queue_name="testqueue-return", connection="AzureWebJobsStorage"
)
@app.blob_output(
    arg_name="$return",
    connection="AzureWebJobsStorage",
