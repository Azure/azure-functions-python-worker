...
if NEW_TYPING:
    from typing import (Callable, ClassVar, Generic, Tuple, TypeVar, Union,
                        _GenericAlias)
else:
    from typing import (Callable, CallableMeta, GenericMeta, TupleMeta,
                        TypeVar, Union, _ClassVar, _Union)
