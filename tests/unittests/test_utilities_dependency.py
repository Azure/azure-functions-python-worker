...
class TestDependencyManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._customer_func_path = os.path.abspath(
            os.path.join(testutils.UNIT_TESTS_ROOT, "resources", "customer_func_path")
        )
        self._worker_deps_path = os.path.abspath(
            os.path.join(testutils.UNIT_TESTS_ROOT, "resources", "worker_deps_path")
        )
        self._customer_deps_path = os.path.abspath(
            os.path.join(testutils.UNIT_TESTS_ROOT, "resources", "customer_deps_path")
        )
    ...
    def test_get_cx_deps_path_in_script_root_with_sys_path_linux_py36(self):
        ...
        sys.path.append(
            "/home/site/wwwroot/.python_packages/sites/lib/" "python3.6/site-packages/"
        )
        os.environ["AzureWebJobsScriptRoot"] = "/home/site/wwwroot"
        result = DependencyManager._get_cx_deps_path()
        self.assertEqual(
    ...
    def test_get_cx_deps_path_in_script_root_with_sys_path_linux(self):
        ...
        sys.path.append(
            "/home/site/wwwroot/.python_packages/sites/lib/" "site-packages/"
        )
        os.environ["AzureWebJobsScriptRoot"] = "/home/site/wwwroot"
        result = DependencyManager._get_cx_deps_path()
        self.assertEqual(
            result, "/home/site/wwwroot/.python_packages/sites/" "lib/site-packages/"
        )
    ...
    def test_get_cx_deps_path_in_script_root_with_sys_path_windows(self):
        ...
        os.environ["AzureWebJobsScriptRoot"] = "C:\\FunctionApp"
        result = DependencyManager._get_cx_deps_path()
        self.assertEqual(result, "C:\\FunctionApp\\sites\\lib\\site-packages")
    ...
    def test_get_worker_deps_path_from_linux_azure_environment(self):
        ...
        result = DependencyManager._get_worker_deps_path()
        self.assertEqual(result, "/azure-functions-host/workers/python/3.7/LINUX/X64")
    ...
    def test_add_to_sys_path_no_duplication(self):
        ...
        DependencyManager._add_to_sys_path(self._customer_deps_path, True)
        path_count = len(
            list(filter(lambda x: x == self._customer_deps_path, sys.path))
        )
    ...
    def test_reload_all_modules_from_customer_deps(self):
        ...
        DependencyManager.prioritize_customer_dependencies(self._customer_func_path)
