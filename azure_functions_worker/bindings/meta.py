    ...
    *,
    ...
    if shared_mem_value is not None:
        ...
        return protos.ParameterBinding(
            name=out_name, rpc_shared_memory=shared_mem_value
        )
    else:
        ...
        return protos.ParameterBinding(name=out_name, data=rpc_val)
