...
if [[ $1 != "3.7" && $1 != "3.8" ]]; then
    python -m pip install --pre -U --no-deps azurefunctions-extensions-bindings-blob==1.1.1
    python -m pip install --pre -U --no-deps azurefunctions-extensions-bindings-eventhub==1.0.0b1
