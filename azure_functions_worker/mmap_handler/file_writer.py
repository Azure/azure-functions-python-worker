...
class FileWriter:
    ...
    def create_with_content_bytes(self, mem_map_name: str, content: bytes) -> Optional[mmap.mmap]:
        """
    ...
    def create_with_content_string(self, mem_map_name: str, content: str) -> Optional[mmap.mmap]:
        """
        ...
        return self.create_with_content_bytes(mem_map_name, content_bytes)
