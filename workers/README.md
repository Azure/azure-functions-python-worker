...
Python support for Azure Functions is based on Python 3.8, 3.9, 3.10, 3.11, 3.12, 3.13, and 3.14 serverless hosting on Linux and the Functions 4.0 runtime.

Here is the current status of Python in Azure Functions:

What are the supported Python versions?

| Azure Functions Runtime          | Python 3.8 | Python 3.9 | Python 3.10 | Python 3.11 | Python 3.12 | Python 3.13 | Python 3.14 |
|----------------------------------|------------|------------|-------------|-------------|-------------|-------------|-------------|
