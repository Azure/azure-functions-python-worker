...
@app.generic_trigger(arg_name="req", type="httpTrigger", route="get_blob_as_bytes")
...
@app.generic_trigger(
    arg_name="req", type="httpTrigger", route="get_blob_as_bytes_return_http_response"
)
@app.generic_output_binding(arg_name="$return", type="http")
@app.generic_input_binding(
    arg_name="file",
...
def get_blob_as_bytes_return_http_response(
    req: func.HttpRequest, file: bytes
) -> func.HttpResponse:
    """
...
def get_blob_as_bytes_stream_return_http_response(
...
@app.generic_trigger(arg_name="req", type="httpTrigger", route="get_blob_as_str")
@app.generic_output_binding(arg_name="$return", type="http")
@app.generic_input_binding(
    arg_name="file",
    connection="AzureWebJobsStorage",
...
@app.generic_trigger(
    arg_name="req", type="httpTrigger", route="get_blob_as_str_return_http_response"
)
@app.generic_output_binding(arg_name="$return", type="http")
@app.generic_input_binding(
    arg_name="file",
...
def get_blob_as_str_return_http_response(
    req: func.HttpRequest, file: str
) -> func.HttpResponse:
    """
    ...
    response_dict = {"num_chars": num_chars, "content_md5": content_md5}
...
@app.generic_trigger(arg_name="req", type="httpTrigger", route="get_blob_bytes")
@app.generic_output_binding(arg_name="$return", type="http")
@app.generic_input_binding(
    arg_name="file",
    connection="AzureWebJobsStorage",
...
@app.generic_trigger(arg_name="req", type="httpTrigger", route="get_blob_filelike")
@app.generic_output_binding(arg_name="$return", type="http")
@app.generic_input_binding(
    arg_name="file",
    connection="AzureWebJobsStorage",
...
@app.generic_trigger(arg_name="req", type="httpTrigger", route="get_blob_return")
@app.generic_output_binding(arg_name="$return", type="http")
@app.generic_input_binding(
    arg_name="file",
    connection="AzureWebJobsStorage",
...
@app.generic_trigger(arg_name="req", type="httpTrigger", route="get_blob_str")
@app.generic_output_binding(arg_name="$return", type="http")
@app.generic_input_binding(
    arg_name="file",
    connection="AzureWebJobsStorage",
...
@app.generic_trigger(
    arg_name="req", type="httpTrigger", route="put_blob_as_bytes_return_http_response"
)
@app.generic_output_binding(
    arg_name="file",
    type="blob",
...
def put_blob_as_bytes_return_http_response(
    req: func.HttpRequest, file: func.Out[bytes]
) -> func.HttpResponse:
    """
...
@app.generic_trigger(
    arg_name="req", type="httpTrigger", route="put_blob_as_str_return_http_response"
)
@app.generic_output_binding(
    arg_name="file",
    type="blob",
...
def put_blob_as_str_return_http_response(
    req: func.HttpRequest, file: func.Out[str]
) -> func.HttpResponse:
    """
...
@app.generic_trigger(arg_name="req", type="httpTrigger", route="put_blob_filelike")
@app.generic_output_binding(arg_name="$return", type="http")
@app.generic_output_binding(
    arg_name="file",
    type="blob",
...
def put_blob_filelike(req: func.HttpRequest, file: func.Out[io.StringIO]) -> str:
    file.set(io.StringIO("filelike"))
    return "OK"


@app.function_name(name="put_blob_return")
@app.generic_trigger(arg_name="req", type="httpTrigger", route="put_blob_return")
@app.generic_output_binding(
    arg_name="$return",
    type="blob",
    connection="AzureWebJobsStorage",
...
@app.generic_trigger(arg_name="req", type="httpTrigger", route="put_blob_str")
@app.generic_output_binding(arg_name="$return", type="http")
@app.generic_output_binding(
    arg_name="file",
    type="blob",
...
@app.generic_output_binding(arg_name="$return", type="http")
@app.generic_trigger(arg_name="req", type="httpTrigger", route="put_blob_trigger")
@app.generic_output_binding(
    arg_name="file",
    type="blob",
    connection="AzureWebJobsStorage",
...
def put_get_multiple_blobs_as_bytes_return_http_response(
    ...
    output_content_2, output_content_md5_2 = _generate_content_and_digest(
