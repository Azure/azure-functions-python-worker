...
class WebHostTestCase(unittest.TestCase, metaclass=WebHostTestCaseMeta):
    ...
    def setUpClass(cls):
        ...
        try:
            ...
            if cls.webhost._proc.errors is not None or cls.webhost._proc.stderr is not None:
                raise RuntimeError(
                    f'Failed to start WebHost: {cls.webhost._proc.errors or cls.webhost._proc.stderr}')
        except Exception:
