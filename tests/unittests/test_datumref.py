...
class TestDatumRef(unittest.TestCase):
    ...
    def test_parse_cookie_attr_expires_valid(self):
        self.assertEqual(
            parse_cookie_attr_expires({"expires": "Thu, 12-Jan-2017 13:55:08 GMT"}),
            parser.parse("Thu, 12-Jan-2017 13:55:08 GMT"),
        )

    def test_parse_cookie_attr_expires_parse_error(self):
        with self.assertRaises(ParserError):
            parse_cookie_attr_expires({"expires": "Thu, 12-Jan-2017 13:550:08 GMT"})
    ...
    def test_parse_cookie_attr_same_site_lax(self):
        self.assertEqual(
            parse_cookie_attr_same_site({"samesite": "lax"}),
    ...
    def test_parse_cookie_attr_same_site_explicit_none(self):
        self.assertEqual(
            parse_cookie_attr_same_site({"samesite": "none"}),
    ...
    def test_parse_to_rpc_http_cookie_list_valid(self):
        ...
        cookie1 = RpcHttpCookie(
            name="foo",
            value="bar",
            domain=to_nullable_string("123", "cookie.domain"),
            path=to_nullable_string("/some/path", "cookie.path"),
            ...
            secure=to_nullable_bool(bool("True"), "cookie.secure"),
            http_only=to_nullable_bool(bool("True"), "cookie.httpOnly"),
            same_site=parse_cookie_attr_same_site({"samesite": "Lax"}),
            max_age=to_nullable_double(12345, "cookie.maxAge"),
        )

        cookie2 = RpcHttpCookie(
            name="foo2",
            value="bar",
            domain=to_nullable_string("123", "cookie.domain"),
            path=to_nullable_string("/some/path2", "cookie.path"),
            expires=to_nullable_timestamp(
                parse_cookie_attr_expires(
                    {"expires": "Thu, " "12-Jan-2017 13:55:08" " GMT"}
                ),
    ...
    def test_parse_to_rpc_http_cookie_list_no_cookie(self):
        ...
        self.assertIsNone(parse_to_rpc_http_cookie_list(datum.value.get("cookies")))
