...
class TestDependencyManager(unittest.TestCase):
    ...
    def test_get_cx_deps_path_in_script_root_with_sys_path_linux_py36(self):
        ...
        sys.path.append(
            "/home/site/wwwroot/.python_packages/sites/lib/"
        ...
        self.assertEqual(
            result,
            "/home/site/wwwroot/.python_packages/sites/"
    ...
    def test_get_worker_deps_path_from_linux_azure_environment(self):
        ...
        result = DependencyManager._get_worker_deps_path()
        self.assertEqual(
            result, "/azure-functions-host/workers/python/3.7/LINUX/X64"
        )
    ...
    @unittest.skipUnless(
        is_python_version("3.10"), "Test only available for python 3.10"
    )
    ...
    @unittest.skipIf(
        is_python_version("3.10"), "Test not available for python 3.10"
    )
