...
@app.route()
@app.cosmos_db_input(
    arg_name="docs_snake", database_name="test",
    container_name="items",
    id="cosmosdb-input-test",
    connection="AzureWebJobsCosmosDBConnectionString")
def cosmosdb_input(req: func.HttpRequest, docs_snake: func.DocumentList) -> str:
...
def cosmosdb_trigger(docs_snake: func.DocumentList) -> str:
...
@app.cosmos_db_output(
    arg_name="doc_snake", database_name="test",
    container_name="items",
    create_if_not_exists=True,
    connection="AzureWebJobsCosmosDBConnectionString")
def put_document(req: func.HttpRequest, doc_snake: func.Out[func.Document]):
