...
**Python Version Coverage**
   ...
   - If yes, have the changes been made to:
      - [ ] azure_functions_worker (Python <= 3.12)
      - [ ] azure_functions_runtime_v1 / azure_functions_runtime (Python >= 3.13)
   - If no, please explain why:

**Programming Model Compatibility (for Python 3.13+)**
- Does this change apply to both:
   - [ ] V1 programming model (azure_functions_runtime_v1)?
   - [ ] V2 programming model (azure_functions_runtime)?
