...
from tests.protos.identity import ClaimsIdentityRpc_pb2 as identity_dot_ClaimsIdentityRpc__pb2
from tests.protos.shared import NullableTypes_pb2 as shared_dot_NullableTypes__pb2
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_WORKERINITREQUEST_CAPABILITIESENTRY']._loaded_options = None
  _globals['_WORKERINITREQUEST_CAPABILITIESENTRY']._serialized_options = b'8\001'
  _globals['_WORKERINITREQUEST_LOGCATEGORIESENTRY']._loaded_options = None
  _globals['_WORKERINITREQUEST_LOGCATEGORIESENTRY']._serialized_options = b'8\001'
  _globals['_WORKERINITRESPONSE_CAPABILITIESENTRY']._loaded_options = None
  _globals['_WORKERINITRESPONSE_CAPABILITIESENTRY']._serialized_options = b'8\001'
  _globals['_WORKERMETADATA_CUSTOMPROPERTIESENTRY']._loaded_options = None
  _globals['_WORKERMETADATA_CUSTOMPROPERTIESENTRY']._serialized_options = b'8\001'
  _globals['_FUNCTIONENVIRONMENTRELOADREQUEST_ENVIRONMENTVARIABLESENTRY']._loaded_options = None
  _globals['_FUNCTIONENVIRONMENTRELOADREQUEST_ENVIRONMENTVARIABLESENTRY']._serialized_options = b'8\001'
  _globals['_FUNCTIONENVIRONMENTRELOADRESPONSE_CAPABILITIESENTRY']._loaded_options = None
  _globals['_FUNCTIONENVIRONMENTRELOADRESPONSE_CAPABILITIESENTRY']._serialized_options = b'8\001'
  _globals['_CLOSESHAREDMEMORYRESOURCESRESPONSE_CLOSEMAPRESULTSENTRY']._loaded_options = None
  _globals['_CLOSESHAREDMEMORYRESOURCESRESPONSE_CLOSEMAPRESULTSENTRY']._serialized_options = b'8\001'
  _globals['_RPCFUNCTIONMETADATA_BINDINGSENTRY']._loaded_options = None
  _globals['_RPCFUNCTIONMETADATA_BINDINGSENTRY']._serialized_options = b'8\001'
  _globals['_RPCFUNCTIONMETADATA_PROPERTIESENTRY']._loaded_options = None
  _globals['_RPCFUNCTIONMETADATA_PROPERTIESENTRY']._serialized_options = b'8\001'
  _globals['_INVOCATIONREQUEST_TRIGGERMETADATAENTRY']._loaded_options = None
  _globals['_INVOCATIONREQUEST_TRIGGERMETADATAENTRY']._serialized_options = b'8\001'
  _globals['_RPCTRACECONTEXT_ATTRIBUTESENTRY']._loaded_options = None
  _globals['_RPCTRACECONTEXT_ATTRIBUTESENTRY']._serialized_options = b'8\001'
  _globals['_BINDINGINFO_PROPERTIESENTRY']._loaded_options = None
  _globals['_BINDINGINFO_PROPERTIESENTRY']._serialized_options = b'8\001'
  _globals['_RPCLOG_PROPERTIESMAPENTRY']._loaded_options = None
  _globals['_RPCLOG_PROPERTIESMAPENTRY']._serialized_options = b'8\001'
  _globals['_RPCHTTP_HEADERSENTRY']._loaded_options = None
  _globals['_RPCHTTP_HEADERSENTRY']._serialized_options = b'8\001'
  _globals['_RPCHTTP_PARAMSENTRY']._loaded_options = None
  _globals['_RPCHTTP_PARAMSENTRY']._serialized_options = b'8\001'
  _globals['_RPCHTTP_QUERYENTRY']._loaded_options = None
  _globals['_RPCHTTP_QUERYENTRY']._serialized_options = b'8\001'
  _globals['_RPCHTTP_NULLABLEHEADERSENTRY']._loaded_options = None
  _globals['_RPCHTTP_NULLABLEHEADERSENTRY']._serialized_options = b'8\001'
  _globals['_RPCHTTP_NULLABLEPARAMSENTRY']._loaded_options = None
  _globals['_RPCHTTP_NULLABLEPARAMSENTRY']._serialized_options = b'8\001'
  _globals['_RPCHTTP_NULLABLEQUERYENTRY']._loaded_options = None
  _globals['_RPCHTTP_NULLABLEQUERYENTRY']._serialized_options = b'8\001'
