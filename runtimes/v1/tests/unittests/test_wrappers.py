...
from azure_functions_runtime_v1.utils import wrappers
...
class TestAttachMessageToException(unittest.TestCase):
    ...
    def test_attach_message_to_exception_catches_and_logs(self,
                                                          mock_extend,
                                                          mock_logger):
        ...
        decorated = wrappers.attach_message_to_exception(ValueError,
                                                         "extra info")(faulty_func)
