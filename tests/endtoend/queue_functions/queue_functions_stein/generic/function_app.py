...
@app.generic_trigger(arg_name="req", type="httpTrigger", route="get_queue_blob")
...
def get_queue_blob(req: func.HttpRequest, file: func.InputStream) -> str:
    return json.dumps({"queue": json.loads(file.read().decode("utf-8"))})


@app.function_name(name="get_queue_blob_message_return")
@app.generic_trigger(
    arg_name="req", type="httpTrigger", route="get_queue_blob_message_return"
)
@app.generic_output_binding(arg_name="$return", type="http")
@app.generic_input_binding(
    arg_name="file",
...
def get_queue_blob_message_return(req: func.HttpRequest, file: func.InputStream) -> str:
    return file.read().decode("utf-8")


@app.function_name(name="get_queue_blob_return")
@app.generic_trigger(arg_name="req", type="httpTrigger", route="get_queue_blob_return")
@app.generic_output_binding(arg_name="$return", type="http")
@app.generic_input_binding(
    arg_name="file",
    type="blob",
...
@app.generic_trigger(
    arg_name="req", type="httpTrigger", route="get_queue_untyped_blob_return"
)
@app.generic_output_binding(arg_name="$return", type="http")
@app.generic_input_binding(
    arg_name="file",
...
def get_queue_untyped_blob_return(req: func.HttpRequest, file: func.InputStream) -> str:
    return file.read().decode("utf-8")


@app.function_name(name="put_queue")
@app.generic_trigger(arg_name="req", type="httpTrigger", route="put_queue")
@app.generic_output_binding(arg_name="$return", type="http")
...
@app.generic_trigger(
    arg_name="req", type="httpTrigger", route="put_queue_message_return"
)
...
@app.generic_trigger(arg_name="req", type="httpTrigger", route="put_queue_multiple_out")
@app.generic_output_binding(arg_name="resp", type="http")
@app.generic_output_binding(
    arg_name="msg",
    type="queue",
...
@app.generic_trigger(arg_name="req", type="httpTrigger", route="put_queue_return")
@app.generic_output_binding(arg_name="resp", type="http")
@app.generic_output_binding(
    arg_name="$return",
    type="queue",
...
@app.generic_trigger(
    arg_name="req", type="httpTrigger", route="put_queue_multiple_return"
)
@app.generic_output_binding(arg_name="$return", type="http")
@app.generic_output_binding(
    arg_name="msgs",
...
def put_queue_multiple_return(req: func.HttpRequest, msgs: func.Out[typing.List[str]]):
    msgs.set(["one", "two"])


@app.function_name(name="put_queue_untyped_return")
@app.generic_trigger(
    arg_name="req", type="httpTrigger", route="put_queue_untyped_return"
)
@app.generic_output_binding(arg_name="resp", type="http")
@app.generic_output_binding(
    arg_name="$return",
...
def put_queue_untyped_return(req: func.HttpRequest, resp: func.Out[str]) -> bytes:
    return func.QueueMessage(body=req.get_body())
...
@app.generic_trigger(
    arg_name="req", type="httpTrigger", route="put_queue_return_multiple"
)
@app.generic_output_binding(arg_name="resp", type="http")
@app.generic_output_binding(
    arg_name="msgs",
...
def put_queue_return_multiple(
    req: func.HttpRequest, resp: func.Out[str], msgs: func.Out[typing.List[str]]
):
    msgs.set(["one", "two"])
